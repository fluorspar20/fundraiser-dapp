...
export default function Detail({ Data, DonationsData }) {
  ...
  useEffect(() => {
    const Request = async () => {
      ...
      fetch("https://ipfs.infura.io/ipfs/" + Data.descUrl)
        .then((res) => res.text())
        .then((data) => (descData = data));
  ...
  return (
    <DetailWrapper>
      <LeftContainer>
        <ImageSection>
          <Image layout="fill" src={"https://ipfs.infura.io/ipfs/" + Data.image} />
        </ImageSection>
...
export async function getStaticProps(context) {
  ...
  const descUrl = await contract.description();
